...
public class ResetAccountActivity extends BaseActivity implements View.OnClickListener,AdapterView.OnItemSelectedListener{
    ...
    public void init(){
        ...
        arrayAdapter = new ArrayAdapter(this,R.layout.spinner_item,
                getResources().getStringArray(R.array.security_question_array));
    ...
    public void initData(){
        securityQuestion1 = getResources().getStringArray(R.array.security_question_array)[0];
        securityQuestion2 = getResources().getStringArray(R.array.security_question_array)[0];
        securityQuestion3 = getResources().getStringArray(R.array.security_question_array)[0];
    }
