...
public abstract class RadioDialog extends Dialog implements View.OnClickListener,RadioGroup.OnCheckedChangeListener{
    ...
    //默认单选按钮1被选中
    private boolean isRb1Checked = true;
    ...
    public void init(){
        ...
        if(SpUtil.getAutomaticUpdateStatus(context).equals(context.getResources().getString(R.string.never))){
