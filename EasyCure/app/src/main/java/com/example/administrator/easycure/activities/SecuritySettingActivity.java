...
public class SecuritySettingActivity extends BaseActivity implements View.OnClickListener,AdapterView.OnItemSelectedListener{
    ...
    public void init(){
        ...
        activity_security_setting_sp1.setAdapter(arrayAdapter);
        activity_security_setting_sp2.setAdapter(arrayAdapter);
        activity_security_setting_sp3.setAdapter(arrayAdapter);
